...
#if DEBUG
  #define SerialCOM_BEGIN(x)      Serial2.begin(x)
  #define SerialCOM_PRINT(...)    Serial2.print(__VA_ARGS__)
  #define SerialCOM_PRINTLN(...)  Serial2.println(__VA_ARGS__)
#else
  #define SerialCOM_BEGIN(x)
  #define SerialCOM_PRINT(...)
  #define SerialCOM_PRINTLN(...)
#endif
